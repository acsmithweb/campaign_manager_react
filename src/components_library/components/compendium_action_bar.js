  ...
  render(){
    return (
      <div className='compendium-sub-nav-bar'>
        <ReactBootStrap.Button variant="success" onClick={this.props.createAction}> Add {this.props.object}</ReactBootStrap.Button>
        <ReactBootStrap.Button variant="danger" onClick={this.props.deleteAction}> Remove {this.props.object}</ReactBootStrap.Button>
        <ReactBootStrap.Button variant="warning" onClick={this.props.editAction}> Edit {this.props.object} </ReactBootStrap.Button>
        <ReactBootStrap.Form>
